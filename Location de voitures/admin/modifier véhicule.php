...
$msg="Mises à jour des données avec succès";
}
	?>
<!doctype html>
...
<head>
	...
	<title>Location de voitures | Administrateur modifie les informations du véhicule</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Modification du véhicule</h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Infos de base</div>
									<div class="panel-body">
<?php if($msg){?><div class="succWrap"><strong>SUCCÈS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
<?php 
$id=intval($_GET['id']);
...
<label class="col-sm-2 control-label">Titre du véhicule<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Vue d'ensemble du véhicule<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Prix ​​par jour (en DHs)<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changerimage1.php?imgid=<?php echo htmlentities($result->id)?>">Changer l'image 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changerimage2.php?imgid=<?php echo htmlentities($result->id)?>">Changer l'image 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="changerimage3.php?imgid=<?php echo htmlentities($result->id)?>">Changer l'image 3</a>
</div>
</div>
...
<a href="changerimage4.php?imgid=<?php echo htmlentities($result->id)?>">Changer l'image 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="changerimage5.php?imgid=<?php echo htmlentities($result->id)?>">Changer l'image 5</a>
<?php } ?>
</div>
...
<label for="inlineCheckbox3"> Capteur accident </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
