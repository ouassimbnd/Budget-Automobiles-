...
$query -> execute();
$msg="véhicule supprimée avec succès";
}
 ?>
...
<head>
	...
	<title>Location de voitures |Admin gére les véhicules   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gérer les véhicules</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Détails véhicule</div>
...
{				?>	
		...
		<td><a href="modifier véhicule.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="gérer les véhicules.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
									</tbody>
								</table>
