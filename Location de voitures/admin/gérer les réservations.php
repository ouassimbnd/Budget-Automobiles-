				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Infos réservation</div>
...
{				?>	
										<tr>
											...
											<td><a href="modifier véhicule.php?id=<?php echo htmlentities($result->vid);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></td>
...
echo htmlentities('Confirmer');
 	...
 	echo htmlentities('Annuler');
										...
										<td><a href="gérer les réservations.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Confirm this booking')"> Confirmer</a> /


<a href="gérer les réservations.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Annuler</a>
</td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
