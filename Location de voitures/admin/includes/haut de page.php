<div class="brand clearfix">
	<a href="tableau de bord.php" style="font-size: 20px;">Location de voitures | Panneau d'administration</a>  
		...
		<ul class="ts-profile-nav">
			...
			<li class="ts-account">
				...
				<ul>
					<li><a href="Changer mot de passe.php">Changer mot de passe</a></li>
