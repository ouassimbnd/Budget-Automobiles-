...
<title>Location de voitures | Les détails du véhicule</title>
<!--Bootstrap -->
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p><?php echo htmlentities($result->PricePerDay);?> </p> DH Par jour
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Vue d'ensemble du véhicule </a></li>
...
<tr>
<td>Serrures de porte électriques</td>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Réserve maintenant</h5>
          </div>
          <form method="post">
